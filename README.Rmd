...
We provide example code: simulation_code.R to reproduce simulation results in Section 4.1.2 of our paper. 
...
Rscript simulation_code.R --power=0 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0 --kernel='linear' --seed_num=123 --n_sim=50 --output_file='example_type_I_error_result_500cl_20expo_20out_linearK_rho0.5.csv' 

Rscript simulation_code.R --power=0 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0 --kernel='gaussian' --seed_num=123 --n_sim=50 --output_file='example_type_I_error_result_500cl_20expo_20out_gaussK_rho0.5.csv' 

```

### Simulation to evaluate power of **HSIC~cl~** and competing methods (Figure 2)
```{r, engine = 'bash', eval = FALSE}
Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.1 --kernel='linear' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.1.csv' 

Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.2 --kernel='linear' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.2.csv'  

Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.3 --kernel='linear' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.3.csv' 

Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.4 --kernel='linear' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.4.csv' 


Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.1 --kernel='gaussian' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.1.csv' 

Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.2 --kernel='gaussian' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.2.csv'  

Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.3 --kernel='gaussian' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.3.csv' 

Rscript simulation_code.R --power=1 --m=500 --d=3 --n_expo=20 --rho_c=0.5 --gamma=0.4 --kernel='gaussian' --seed_num=123 --n_sim=50 --output_file='example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.4.csv' 
...
Example output files of the above Bash commands are provided in the "code" folder. We next return to R and analyze these output files.
...
type_I_error_result <- data.frame('alpha'=rep(c(0.1, 0.05),each=2),'rho_c'=0.5,
                                  ...
                                  'HSIC_cl'=NA)
type_I_error_result[1,4:5] <- result_eval(power_ind=0,   "example_type_I_error_result_500cl_20expo_20out_linearK_rho0.5.csv", sig_level=0.1)
type_I_error_result[3,4:5] <- result_eval(power_ind=0,   "example_type_I_error_result_500cl_20expo_20out_linearK_rho0.5.csv", sig_level=0.05)
type_I_error_result[2,4:5] <- result_eval(power_ind=0,   "example_type_I_error_result_500cl_20expo_20out_gaussK_rho0.5.csv", sig_level=0.1)
type_I_error_result[4,4:5] <- result_eval(power_ind=0,   "example_type_I_error_result_500cl_20expo_20out_gaussK_rho0.5.csv", sig_level=0.05)
...
power_result_linear[,2] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.1.csv", sig_level=0.05)
power_result_linear[,3] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.2.csv", sig_level=0.05)
power_result_linear[,4] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.3.csv", sig_level=0.05)
power_result_linear[,5] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_linearK_rho0.5_gamma0.4.csv", sig_level=0.05)
...
power_result_gauss <- data.frame('Method'=c('HSIC_cl','HSIC_cat','HSIC_mean'),
                                  'effsize1'=NA, 'effsize2'=NA, 'effsize3'=NA, 'effsize4'=NA)
power_result_gauss[,2] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.1.csv", sig_level=0.05)
power_result_gauss[,3] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.2.csv", sig_level=0.05)
power_result_gauss[,4] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.3.csv", sig_level=0.05)
power_result_gauss[,5] <- result_eval(power_ind=1,   "example_power_result_500cl_20expo_20out_gaussK_rho0.5_gamma0.4.csv", sig_level=0.05)
...
## License
All content in the "code" folder is licensed under the GPL-3.0 license.
