...
# test_stat: value of the test statistic (trace of the product of the two centered kernel matrices)
# pval: p-value from the independence test
...
HSIC_cl <- function(m, expo.K.c, outcome.K.c, kernel_type = NULL, n_expo = NULL,
  ...
  # Estimate the null distribution of HSIC statistic
